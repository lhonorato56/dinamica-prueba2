  ...
  lessons: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { t: 'fig', img: 'img/c2022-alcu.png', cap: 'Enunciado original (C2 2022): aluminio m₁ y cobre m₂ unidos por una polea, con la tabla de coeficientes.' },
        { t: 'example', title: 'Resolución del bloque aluminio/cobre', level: 'medio', dcl: FIG.dcl({cap:'Bloque en el plano: peso, normal (perpendicular), tensión (sube el plano) y roce.',forces:[{deg:270,label:'mg',c:FIG.C.RED},{deg:120,label:'N',c:FIG.C.GRE},{deg:30,label:'T',c:FIG.C.ACC},{deg:210,label:'f',c:FIG.C.AMB}]}),
          body: '<p>Intenta resolverlo tú con el enunciado de arriba antes de ver la solución. 👇</p>',
          solution: '<div class="steps"><div class="step"><b>📷 El dibujo:</b> el bloque de aluminio m₁ está sobre la superficie horizontal y el de cobre m₂ sobre el plano inclinado 30°; una cuerda los conecta por la polea del vértice. La tabla del enunciado da los coeficientes de roce de cada material con el acero.</div><div class="step"><b>DCL.</b> $m_1$ (horizontal): $N_1=m_1g=200$ N; lo que jala es la tensión. $m_2$ (plano): $N_2=m_2g\\cos30=60\\cdot10\\cdot0{,}87\\approx522$ N; lo que tiende a bajar es $m_2g\\sin30=60\\cdot10\\cdot0{,}5=300$ N.</div><div class="step"><b>Fuerza motriz</b> del sistema = $m_2g\\sin30=300$ N (tira de todo hacia abajo del plano).</div><div class="step"><b>Roce estático máximo</b> de ambos: $f_{1max}=\\mu_{s1}N_1=0{,}61\\cdot200=122$ N; $f_{2max}=\\mu_{s2}N_2=0{,}74\\cdot522\\approx386$ N. Pero ojo: el problema pide la suma de roces; el máximo combinado que se opone es $122+386\\approx508$ N (en la pauta usan $\\approx398{,}66$ N con otros coeficientes de la tabla).</div><div class="step"><b>Comparo:</b> fuerza motriz $300$ N $<$ roce estático máximo disponible. Por lo tanto <b>NO se mueve</b>.</div><div class="step"><b>(c)</b> Como $a=0$, la suma de las fuerzas de roce iguala a la fuerza motriz: $\\boxed{f_1+f_2=m_2g\\sin30=300\\text{ N}}$. (El roce estático solo aporta lo necesario, no su máximo.)</div></div>' },
        { t: 'fig', img: 'img/a6-resorte345.png', cap: 'Figura original (Ayudantía 6): bloque con resorte k=200 N/m y fuerza F=100 N.' },
        { t: 'example', title: 'Enunciado real (Ayudantía 6) — resorte 3-4-5', level: 'medio', dcl: FIG.dcl({cap:'Bloque liso: peso, normal, fuerza F (horizontal) y fuerza del resorte.',forces:[{deg:270,label:'mg',c:FIG.C.RED},{deg:90,label:'N',c:FIG.C.GRE},{deg:180,label:'F',c:FIG.C.ACC},{deg:37,label:'Fe',c:FIG.C.PUR}]}),
        ...
        { t: 'fig', img: 'img/a6-autocuesta.png', cap: 'Figura original (Ayudantía 6): auto que sube; en A la pendiente disminuye.' },
        { t: 'example', title: 'Enunciado real (Ayudantía 6) — auto en cuesta', level: 'medio', dcl: FIG.dcl({cap:'Auto en la cuesta: peso, normal y fuerza del motor (sube el plano).',forces:[{deg:270,label:'mg',c:FIG.C.RED},{deg:120,label:'N',c:FIG.C.GRE},{deg:30,label:'Fmotor',c:FIG.C.ACC}]}),
        ...
        { t: 'example', title: 'Enunciado real (Taller 4) — bloque con polea y cubo', level: 'dificil', dcl: FIG.dcl({cap:'Cubo m: peso, normal del bloque (horizontal), la fuerza F (sube) y el roce.',forces:[{deg:265,label:'mg',c:FIG.C.RED},{deg:285,label:'f',c:FIG.C.AMB},{deg:0,label:'N',c:FIG.C.GRE},{deg:90,label:'F',c:FIG.C.ACC}]}),
    ...
    },
    {
      ...
      blocks: [
        ...
        { t: 'fig', img: 'img/c2023-cunaP.png', cap: 'Figura original (C2 2023): cuña m₁ (sobre ruedas) con bloque m₂ y fuerza P.' },
        { t: 'example', title: 'Cuña con bloque que no resbala', level: 'dificil', dcl: FIG.dcl({cap:'Bloque sobre la cuña (sin roce): solo peso y normal.',forces:[{deg:270,label:'mg',c:FIG.C.RED},{deg:120,label:'N',c:FIG.C.GRE}]}),
          body: '<p>Intenta resolverlo tú con el enunciado de arriba antes de ver la solución. 👇</p>',
        ...
        { t: 'fig', img: 'img/c2024-cilindro.png', cap: 'Enunciado original (C2 2024): cilindro en un carrito que acelera 2g subiendo el plano.' },
        { t: 'example', title: 'Cilindro en carrito que acelera 2g', level: 'dificil', dcl: FIG.dcl({cap:'Cilindro: peso, contacto FA (horizontal, pared) y FB (perpendicular al plano).',forces:[{deg:270,label:'mg',c:FIG.C.RED},{deg:0,label:'FA',c:FIG.C.GRE},{deg:127,label:'FB',c:FIG.C.GRE}]}),
          body: '<p>Intenta resolverlo tú con el enunciado de arriba antes de ver la solución. 👇</p>',
          solution: '<div class="steps"><div class="step"><b>📷 El dibujo:</b> el cilindro m se apoya en DOS puntos del carrito: A (pared vertical, normal horizontal) y B (la cara del plano, normal perpendicular al plano). Todo el carrito acelera 2g subiendo el plano, con tan θ = 3/4 (triángulo 3-4-5).</div><div class="step">Ejes a lo largo del plano (x, hacia arriba) y perpendicular (y). La aceleración es $\\vec a=2g\\,\\hat x$.</div><div class="step"><b>Fuerzas sobre el cilindro:</b> $F_A$ horizontal (de la pared del carrito); $F_B$ perpendicular al plano (en y); peso $mg$ vertical hacia abajo. Hay que proyectar $F_A$ y el peso a los ejes del plano.</div><div class="step">Peso en ejes del plano: $-mg\\sin\\theta\\,\\hat x-mg\\cos\\theta\\,\\hat y$. $F_A$ horizontal en ejes del plano: $F_A\\cos\\theta\\,\\hat x-F_A\\sin\\theta\\,\\hat y$.</div><div class="step"><b>Eje x:</b> $F_A\\cos\\theta-mg\\sin\\theta=m(2g)\\Rightarrow F_A(0{,}8)-mg(0{,}6)=2mg\\Rightarrow F_A=\\dfrac{2{,}6mg}{0{,}8}=\\boxed{\\tfrac{13}{4}mg}$.</div><div class="step"><b>Eje y</b> ($a_y=0$): $F_B-mg\\cos\\theta-F_A\\sin\\theta=0\\Rightarrow F_B=mg(0{,}8)+\\tfrac{13}{4}mg(0{,}6)=0{,}8mg+1{,}95mg=\\boxed{\\tfrac{11}{4}mg}$.</div></div>' }
      ]
    },
    {
      ...
      blocks: [
        ...
        { t: 'example', title: 'Enunciado real (Ayudantía 8) — globo', level: 'medio', dcl: FIG.dcl({cap:'Globo: flotación (arriba), peso y resistencia del aire (ambos abajo).',forces:[{deg:90,label:'Fflot',c:FIG.C.ACC},{deg:255,label:'mg',c:FIG.C.RED},{deg:285,label:'FD',c:FIG.C.AMB}]}),
        ...
        { t: 'example', title: 'Enunciado real (Taller 4) — paracaidista', level: 'facil', dcl: FIG.dcl({cap:'Paracaidista cayendo: peso (abajo) y resistencia del aire (arriba).',forces:[{deg:270,label:'mg',c:FIG.C.RED},{deg:90,label:'FD',c:FIG.C.AMB}]}),
  ...
  lessons: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { t: 'fig', img: 'img/c2024-poleamovil.png', cap: 'Figura original (C2 2024): A cuelga de la polea móvil; B sobre la mesa.' },
        { t: 'example', title: 'Sistema con polea móvil (I2 2024)', level: 'dificil', dcl: FIG.dcl({cap:'Bloque A (cuelga): peso hacia abajo y la tensión que lo sostiene.',forces:[{deg:270,label:'mg',c:FIG.C.RED},{deg:90,label:'T1',c:FIG.C.ACC}]}),
          body: '<p>Intenta resolverlo tú con el enunciado de arriba antes de ver la solución. 👇</p>',
        ...
        { t: 'fig', img: 'img/c2024-poleamovil.png', cap: 'Sistema con polea móvil (relación 2:1) — figura tipo del problema.' },
        { t: 'example', title: 'Enunciado real (Compilado 2.16) — dos poleas ideales', level: 'medio', dcl: FIG.dcl({cap:'Bloque M (cuelga): peso hacia abajo y la tensión 2T que lo sostiene.',forces:[{deg:270,label:'mg',c:FIG.C.RED},{deg:90,label:'2T',c:FIG.C.ACC}]}),
    ...
    },
    {
      ...
      blocks: [
        ...
        { t: 'example', title: 'Cuña con poleas y roce (I2 2024) — método mixto', level: 'dificil', dcl: FIG.dcl({cap:'Bloque A baja el plano α: peso, normal, tensión y roce (ambos hacia arriba del plano).',forces:[{deg:270,label:'mg',c:FIG.C.RED},{deg:120,label:'N',c:FIG.C.GRE},{deg:40,label:'T',c:FIG.C.ACC},{deg:20,label:'f',c:FIG.C.AMB}]}),
          body: '<p>Intenta resolverlo tú con el enunciado de arriba antes de ver la solución. 👇</p>',
  ...
  lessons: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { t: 'fig', img: 'img/i2023-rizo.png', cap: 'Enunciado original (I2 2023): resorte comprimido Δ que lanza la masa al rizo de radio a.' },
        { t: 'example', title: 'Rizo con resorte (I2 2023) — energía + condición de loop', level: 'dificil', dcl: FIG.dcl({cap:'En el punto más alto del rizo: la normal y el peso apuntan ambos al centro (abajo).',forces:[{deg:255,label:'N',c:FIG.C.GRE},{deg:285,label:'mg',c:FIG.C.RED}]}),
          body: '<p>Intenta resolverlo tú con el enunciado de arriba antes de ver la solución. 👇</p>',
          solution: '<div class="steps"><div class="step"><b>📷 El dibujo:</b> el resorte (comprimido Δ) lanza la masa m por el piso hasta un rizo vertical de radio a (diámetro 2a, punto más alto C), y luego sigue al punto E, al mismo nivel del resorte. Todo sin roce.</div><div class="step"><b>(a)</b> Energía del resorte $\\tfrac12 k\\Delta^2$ se reparte en $C$ (altura $2a$) entre cinética y potencial: $\\tfrac12 k\\Delta^2=\\tfrac12 mv_C^2+mg(2a)\\Rightarrow \\boxed{v_C^2=\\dfrac{k}{m}\\Delta^2-4ga}$.</div><div class="step"><b>(b)</b> En $E$ (mismo nivel que el resorte, altura 0): toda la energía vuelve a ser cinética: $\\tfrac12 k\\Delta^2=\\tfrac12 mv_E^2\\Rightarrow \\boxed{v_E^2=\\dfrac{k}{m}\\Delta^2}$.</div><div class="step"><b>(c) Condición de loop</b> en $C$: $v_C^2\\ge ga$. Entonces $\\dfrac{k}{m}\\Delta^2-4ga\\ge ga\\Rightarrow \\dfrac{k}{m}\\Delta^2\\ge 5ga\\Rightarrow \\boxed{\\Delta\\ge\\sqrt{\\dfrac{5mga}{k}}}$.</div><div class="step">Ese "$5$" famoso ($v^2=5gR$ abajo para completar un loop) sale justo de combinar energía + condición $N=0$ arriba.</div></div>' }
      ]
    },
    {
      ...
      blocks: [
        ...
        { t: 'example', title: 'Anillo en barra giratoria (I2 2023)', level: 'medio', dcl: FIG.dcl({cap:'Anillo (plano horizontal): reacción radial N_B (hacia el centro) y la normal de la barra F_AB (tangencial).',forces:[{deg:180,label:'NB',c:FIG.C.GRE},{deg:90,label:'FAB',c:FIG.C.ACC}]}),
          body: '<p>Intenta resolverlo tú con el enunciado de arriba antes de ver la solución. 👇</p>',
        ...
        { t: 'example', title: 'Péndulo soltado desde la horizontal', level: 'medio', dcl: FIG.dcl({cap:'Péndulo en el punto más bajo: tensión (hacia el pivote, arriba) y peso.',forces:[{deg:90,label:'T',c:FIG.C.ACC},{deg:270,label:'mg',c:FIG.C.RED}]}),
          body: '<p>Intenta resolverlo tú con el enunciado de arriba antes de ver la solución. 👇</p>',
        ...
        { t: 'fig', img: 'img/a7-domo.png', cap: 'Figura original (Ayudantía 7): bolita que baja por un domo esférico de radio R.' },
        { t: 'example', title: 'Enunciado real (Ayudantía 7) — bolita que se despega de un domo', level: 'dificil', dcl: FIG.dcl({cap:'Bolita en el domo: normal (radial, hacia afuera) y peso.',forces:[{deg:60,label:'N',c:FIG.C.GRE},{deg:270,label:'mg',c:FIG.C.RED}]}),
  ...
  lessons: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { t: 'fig', img: 'img/a8-resortenolineal.png', cap: 'Figura original (Ayudantía 8): bloque que choca con un resorte no lineal.' },
        { t: 'example', title: 'Enunciado real (Ayudantía 8) — resorte no lineal', level: 'medio', dcl: FIG.dcl({cap:'Bloque liso: peso, normal y la fuerza del resorte (se opone al avance).',forces:[{deg:270,label:'mg',c:FIG.C.RED},{deg:90,label:'N',c:FIG.C.GRE},{deg:180,label:'Fs',c:FIG.C.PUR}]}),
    ...
    },
    {
      ...
      blocks: [
        ...
        { t: 'example', title: 'Rampa + roce + resorte (Compilado 3.6)', level: 'medio', dcl: FIG.dcl({cap:'Bloque en el tramo rugoso: peso, normal, roce y (al final) la fuerza del resorte.',forces:[{deg:270,label:'mg',c:FIG.C.RED},{deg:90,label:'N',c:FIG.C.GRE},{deg:0,label:'f',c:FIG.C.AMB},{deg:180,label:'Fe',c:FIG.C.PUR}]}),
          body: '<p>Intenta resolverlo tú con el enunciado de arriba antes de ver la solución. 👇</p>',
        ...
        { t: 'example', title: 'Enunciado real (I2 2021) — camión que acelera una caja', level: 'dificil', dcl: FIG.dcl({cap:'Caja sobre la plataforma: peso, normal y el roce (única fuerza horizontal, la acelera).',forces:[{deg:270,label:'mg',c:FIG.C.RED},{deg:90,label:'N',c:FIG.C.GRE},{deg:0,label:'f',c:FIG.C.AMB}]}),
  ...
  lessons: [
    {
      ...
      blocks: [
        ...
        { t: 'example', title: 'Ejemplo de clase: cilindro entre dos resortes', level: 'medio', dcl: FIG.dcl({cap:'Cilindro: peso y la fuerza de los dos resortes (cada uno tira hacia su anclaje).',forces:[{deg:270,label:'mg',c:FIG.C.RED},{deg:110,label:'Fe',c:FIG.C.PUR},{deg:70,label:'Fe',c:FIG.C.PUR}]}),
    ...
    },
    {
      ...
      blocks: [
        ...
        { t: 'fig', img: 'img/c2021-paquetes.png', cap: 'Figura original (C2 2021): paquetes que bajan la rampa ABC hasta la cinta móvil.' },
        { t: 'example', title: 'Paquetes en rampa con roce (I2 2021)', level: 'dificil', dcl: FIG.dcl({cap:'Paquete en la rampa: peso, normal y roce (opuesto al movimiento, hacia arriba del plano).',forces:[{deg:270,label:'mg',c:FIG.C.RED},{deg:120,label:'N',c:FIG.C.GRE},{deg:30,label:'f',c:FIG.C.AMB}]}),
          body: '<p>Intenta resolverlo tú con el enunciado de arriba antes de ver la solución. 👇</p>',
    ...
    },
    {
      ...
      blocks: [
        ...
        { t: 'example', title: 'Collarín en barra lisa con resorte (Ayudantía 9)', level: 'medio', dcl: FIG.dcl({cap:'Collarín: peso, normal de la barra lisa y la fuerza del resorte.',forces:[{deg:270,label:'mg',c:FIG.C.RED},{deg:90,label:'N',c:FIG.C.GRE},{deg:180,label:'Fe',c:FIG.C.PUR}]}),
          body: '<p>Intenta resolverlo tú con el enunciado de arriba antes de ver la solución. 👇</p>',
        ...
        { t: 'example', title: 'Energía potencial en plano inclinado (Compilado 3.20/3.21)', level: 'medio', dcl: FIG.dcl({cap:'Masa en el plano: peso, normal y la fuerza del resorte (a lo largo del plano).',forces:[{deg:270,label:'mg',c:FIG.C.RED},{deg:120,label:'N',c:FIG.C.GRE},{deg:30,label:'Fe',c:FIG.C.PUR}]}),
          body: '<p>Intenta resolverlo tú con el enunciado de arriba antes de ver la solución. 👇</p>',
        ...
        { t: 'example', title: 'Salto bungee (Taller 5)', level: 'dificil', dcl: FIG.dcl({cap:'Persona (cuerda estirada): peso hacia abajo y la fuerza elástica de la cuerda hacia arriba.',forces:[{deg:270,label:'mg',c:FIG.C.RED},{deg:90,label:'Fe',c:FIG.C.PUR}]}),
          body: '<p>Intenta resolverlo tú con el enunciado de arriba antes de ver la solución. 👇</p>',
    ...
    },
    {
      ...
      blocks: [
        ...
        { t: 'fig', img: 'img/c2021-argolla.png', cap: 'Figura original (C2 2021): argolla en la guía ABCDE con resorte y tramo con roce DE.' },
        { t: 'example', title: 'Argolla en guía con resorte (I2 2021, parte a)', level: 'dificil', dcl: FIG.dcl({cap:'Argolla: peso, normal de la guía y la fuerza del resorte.',shape:'ball',forces:[{deg:270,label:'mg',c:FIG.C.RED},{deg:90,label:'N',c:FIG.C.GRE},{deg:45,label:'Fe',c:FIG.C.PUR}]}),
          body: '<p>Intenta resolverlo tú con el enunciado de arriba antes de ver la solución. 👇</p>',
  ...
  lessons: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { t: 'fig', img: 'img/a10-resortevert.png', cap: 'Figura original (Ayudantía 10): masa que cuelga de un resorte vertical.' },
        { t: 'example', title: 'Enunciado real (Ayudantía 10) — resorte vertical', level: 'medio', dcl: FIG.dcl({cap:'Masa colgando: peso hacia abajo y la fuerza del resorte hacia arriba.',forces:[{deg:270,label:'mg',c:FIG.C.RED},{deg:90,label:'Fe',c:FIG.C.PUR}]}),
        ...
        { t: 'fig', img: 'img/a10-dosresortes.png', cap: 'Figura original (Ayudantía 10): bloque entre dos resortes, paredes separadas 3x₀.' },
        { t: 'example', title: 'Enunciado real (Ayudantía 10) — dos resortes', level: 'medio', dcl: FIG.dcl({cap:'Bloque entre dos resortes: cada resorte tira hacia su lado (más peso y normal).',forces:[{deg:270,label:'mg',c:FIG.C.RED},{deg:90,label:'N',c:FIG.C.GRE},{deg:0,label:'Fe',c:FIG.C.PUR},{deg:180,label:'Fe',c:FIG.C.PUR}]}),
    ...
    },
    {
      ...
      blocks: [
        ...
        { t: 'example', title: 'MAS con polea móvil (I2 2023)', level: 'dificil', dcl: FIG.dcl({cap:'Bloque 1: peso, normal, fuerza del resorte y la tensión 2T (vía la polea móvil).',forces:[{deg:270,label:'mg',c:FIG.C.RED},{deg:90,label:'N',c:FIG.C.GRE},{deg:180,label:'Fe',c:FIG.C.PUR},{deg:0,label:'2T',c:FIG.C.ACC}]}),
          body: '<p>Intenta resolverlo tú con el enunciado de arriba antes de ver la solución. 👇</p>',
        ...
        { t: 'fig', img: 'img/i2024-apilados.png', cap: 'Enunciado original (I2 2024): bloque m sobre M, con resorte k y roce μ entre ellos.' },
        { t: 'example', title: 'Bloques apilados oscilando (I2 2024)', level: 'dificil', dcl: FIG.dcl({cap:'Bloque de arriba (m): peso, normal de M, y el roce estático (única fuerza horizontal, lo acelera).',forces:[{deg:270,label:'mg',c:FIG.C.RED},{deg:90,label:'N',c:FIG.C.GRE},{deg:0,label:'fs',c:FIG.C.AMB}]}),
          body: '<p>Intenta resolverlo tú con el enunciado de arriba antes de ver la solución. 👇</p>',
          solution: '<div class="steps"><div class="step"><b>📷 El dibujo:</b> el bloque grande M va sobre piso SIN roce, unido al resorte k; encima descansa el bloque chico m, y entre m y M hay roce estático μₛ. La idea es que oscilen juntos sin que m resbale.</div><div class="step"><b>(a)</b> Oscilan juntos como masa $M+m$: $T=2\\pi\\sqrt{\\dfrac{M+m}{k}}\\Rightarrow M+m=\\dfrac{kT^2}{4\\pi^2}\\Rightarrow \\boxed{m=\\dfrac{kT^2}{4\\pi^2}-M}$.</div><div class="step"><b>(b)</b> Desde reposo en $d$: $x(t)=d\\cos(\\omega t)$, con $\\omega=\\sqrt{k/(M+m)}$. La aceleración máxima es $a_{max}=d\\omega^2=\\dfrac{kd}{M+m}$.</div><div class="step"><b>(c)</b> La ÚNICA fuerza horizontal sobre $m$ es el roce, que debe darle su aceleración: $f=m\\,a$. En el peor caso $a=a_{max}$, y el roce máximo es $\\mu_s mg$. Condición: $\\mu_s mg\\ge m\\,a_{max}\\Rightarrow \\boxed{\\mu_s\\ge\\dfrac{a_{max}}{g}=\\dfrac{kd}{(M+m)g}}$.</div></div>' },
        ...
        { t: 'fig', img: 'img/a10-cascaron.png', cap: 'Figura original (Ayudantía 10): partícula dentro de un cascarón esférico de radio R.' },
        { t: 'example', title: 'Enunciado real (Ayudantía 10) — cascarón esférico', level: 'dificil', dcl: FIG.dcl({cap:'Partícula en el cascarón: peso y normal (radial, hacia el centro).',shape:'ball',forces:[{deg:270,label:'mg',c:FIG.C.RED},{deg:60,label:'N',c:FIG.C.GRE}]}),
  ...
  lessons: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { t: 'fig', img: 'img/a11-discos2d.png', cap: 'Figura original (Ayudantía 11): choque de discos (antes y después).' },
  ...
  lessons: [
    {
      ...
      blocks: [
        ...
        { t: 'fig', img: 'img/c2023-planoacel.png', cap: 'Figura original (C2 2023): bloque en un plano inclinado que acelera con a.' },
        { t: 'example', title: 'P1 · Newton (I2 2023, enunciado real)', level: 'medio', dcl: FIG.dcl({cap:'Bloque en el plano: peso, normal y roce (estático, hacia arriba del plano).',forces:[{deg:270,label:'mg',c:FIG.C.RED},{deg:120,label:'N',c:FIG.C.GRE},{deg:210,label:'f',c:FIG.C.AMB}]}),
        ...
        { t: 'example', title: 'P2 · Energía + plano con roce (I2 2021, enunciado real)', level: 'dificil', dcl: FIG.dcl({cap:'Bloque en el plano con resorte: peso, normal, fuerza del resorte y roce.',forces:[{deg:270,label:'mg',c:FIG.C.RED},{deg:120,label:'N',c:FIG.C.GRE},{deg:30,label:'Fe',c:FIG.C.PUR},{deg:210,label:'f',c:FIG.C.AMB}]}),
