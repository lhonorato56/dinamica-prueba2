...
## Cómo abrirlo
- **En línea (para compartir):** publicado en GitHub Pages (ver el link). Se abre en
  cualquier celular o computador con internet, sin instalar nada.
...
- **30 lecciones** con teoría, fórmulas con cada variable explicada, y **~48
  ...
  salen en las pruebas (solución desplegable).
...
## Orden sugerido (estás contra el tiempo)
Día 1: U0 (gatillos + qué memorizar) + U1 (Newton) + U4 y U5 (energía, lo que MÁS cae).
Día 2: U2 (poleas) + U3 (circular) + U6 (MAS).
Día 3: U7 (momentum) + rehacer los difíciles.
Víspera: formulario (U8) + simulacro cronometrado.

Convención del curso: **g = 10 m/s²** (a veces 9,8). sin37°≈0,6, cos37°≈0,8 (triángulo 3-4-5).

## Archivos
- `index.html` — la app (ábrelo).
- `styles.css` — estilos. · `app.js` — lógica (navegación, quizzes, progreso).
- `content.js` — TODO el contenido del curso, ordenado por unidades.
